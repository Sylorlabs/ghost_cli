...
pub fn renderNonTty(writer: anytype) !void {
    try writer.writeAll(
        ...
        \\No CLI-owned TUI command was run. No doctor check, context/project autopsy scan, correction proposal, verifier, pack mutation, or negative-knowledge mutation was started from this non-TTY fallback.
